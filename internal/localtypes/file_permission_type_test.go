...
func TestFilePermissionType(t *testing.T) {
	...
	t.Run("ValueFromString", func(t *testing.T) {
...
func TestFilePermissionValue(t *testing.T) {
	t.Run("Equal", func(t *testing.T) {
	...
	t.Run("ValidateAttribute", func(t *testing.T) {
		tests := []struct {
			name      string
			value     string
			wantError bool
